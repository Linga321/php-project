...
(function (e, t, undefined) {
	...
	function i() {
		...
		t.createNavigation = function (a) {
			...
			if (0 === i.length) {
				if (i = e(a.pageInfo.pageNavigation), i.parents("table:first").length > 0 && i.parents("table:first") !== e(a.table))
					return;
				...
				i.off("click", "a[data-page]").on("click", "a[data-page]", function (n) {
					...
					if (l >= 0) {
						if (o.limit && o.currentPage != l) {
							for (var f = l; 0 !== f % o.limitNavigation; )
								f -= 1;
		...
		t.createLimited = function (e, t, a) {
			...
			for (i = t.pages.length - 1; i >= 0; i--)
				o = t.pages[i], i >= a && a + t.limitNavigation > i && o.length > 0 && n.after('<li class="footable-page"><a data-page="' + i + '" href="#">' + (i + 1) + "</a></li>");
			0 === a ? n.hide() : n.show(),
	...
	function a() {
		...
		e.doSort = function (a, i) {
			...
			if (t(o.table).data("sort") !== !1) {
				...
				if (i = i === undefined ? s.hasClass(d.sorted) : "toggle" === i ? !s.hasClass(d.sorted) : i, l.sort.ignore === !0)
					return !0;
